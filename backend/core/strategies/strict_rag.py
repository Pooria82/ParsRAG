...
2. If the context does not contain the answer, you must respond strictly in Persian with:
   "بر اساس اسناد ارائه شده، پاسخی برای این سوال در متن یافت نشد. (I do not know based on the provided documents.)"
